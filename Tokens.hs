...
alex_action_17 = \p s -> TReflectX p
alex_action_18 = \p s -> TReflectY p
alex_action_19 = \p s -> TBlank p
alex_action_20 = \p s -> TAnd p
alex_action_21 = \p s -> TOr p
alex_action_22 = \p s -> TSubtile p
alex_action_23 = \p s -> TGibb p
alex_action_24 = \p s -> TLessThan p
alex_action_25 = \p s -> TGreaterThan p
alex_action_26 = \p s -> TIsEqual p
alex_action_27 = \p s -> TNotEqual p
alex_action_28 = \p s -> TWhile p
alex_action_29 = \p s -> TIf p
alex_action_30 = \p s -> TElse p
alex_action_31 = \p s -> TWidth p
alex_action_32 = \p s -> THeight p
alex_action_33 = \p s -> TPrint p
alex_action_34 = \p s -> TAdd p
alex_action_35 = \p s -> TSub p
alex_action_36 = \p s -> TBoolean p True
alex_action_37 = \p s -> TBoolean p False
alex_action_38 = \p s -> TIdentifier p s
alex_action_39 = \p s -> TNumber p (read s)
