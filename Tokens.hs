...
alex_action_6 = \p s -> TDot p
alex_action_7 = \p s -> TComma p
alex_action_8 = \p s -> TIf p
alex_action_9 = \p s -> TElse p
alex_action_10 = \p s -> TRepeat p
alex_action_11 = \p s -> TPrint p
alex_action_12 = \p s -> TIdentifier p s
alex_action_13 = \p s -> TNumber p (read s)
