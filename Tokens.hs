...
alex_table = listArray (0 :: Int, 1760)
  [ 0
  , 14
  , 14
  , 14
...
alex_check = listArray (0 :: Int, 1760)
  [ -1
  , 9
  , 10
  , 11
...
data Token =
  ...
  deriving (Eq, Show)
alex_action_1 = \p s -> TEquals p
alex_action_2 = \p s -> TLeftBrace p
alex_action_3 = \p s -> TRightBrace p
alex_action_4 = \p s -> TLeftParen p
alex_action_5 = \p s -> TRightParen p
alex_action_6 = \p s -> TIntDivide p
alex_action_7 = \p s -> TDot p
alex_action_8 = \p s -> TComma p
alex_action_9 = \p s -> TIf p
alex_action_10 = \p s -> TElse p
alex_action_11 = \p s -> TRepeat p
alex_action_12 = \p s -> TPrint p
alex_action_13 = \p s -> TIdentifier p s
alex_action_14 = \p s -> TNumber p (read s)
